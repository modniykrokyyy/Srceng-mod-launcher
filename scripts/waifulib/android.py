...
class aapt2compile(javaw.JTask): 
 ...
 def uid(self): 
  ...
  """ 
  return Utils.h_list([self.class.name, self.generator.outdir.abspath(), self.env.RESDIR]) 
...
class d8(DexerTask): 
 # can't use TGT instead of OUTDIR here, because Google code monkeys don't know what output should mean 
